  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-medium": {
          "0%, 100%": { transform: "translate(0, 0) scale(1)" },
          "50%": { transform: "translate(-22px, 20px) scale(1.03)" },
        },
        "float-fast": {
          "0%, 100%": { transform: "translate(0, 0) scale(1)" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsla(153,100%,50%,0.3), 0 0 60px hsla(153,100%,50%,0.1)" },
          "50%": { boxShadow: "0 0 30px hsla(153,100%,50%,0.5), 0 0 80px hsla(153,100%,50%,0.2)" },
        },
        "gentle-bounce": {
